...
docker buildx build --tag scjtqs/tdlib:1.7.0-low --platform linux/amd64,linux/arm64,linux/386,linux/arm/v6,linux/ppc64le,linux/s390x  --push -f Dockerfile.td-lowram .
