...
docker buildx build --tag scjtqs/go-tg:2024-04-19-debian --platform linux/amd64,linux/arm64,linux/386,linux/arm/v7 --push -f bullseye.go-td.Dockerfile . || exit 2
